...
def train_model(learning_rate):
    ...
    drop_out = tf.nn.dropout(prediction3, keep_prob)
    prediction4 = tf.nn.relu(tf.matmul(drop_out, weights4) + bias4, name="prediction4")
    ...
    print("Finished with 5 Layers.")

    try:
        predict(session, prediction4, pixels, directory + "\\bonito\\1.jpg")
        predict(session, prediction4, pixels, directory + "\\bonito\\2.jpg")
        predict(session, prediction4, pixels, directory + "\\bonito\\3.jpg")
    except:
